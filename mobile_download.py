"""
Mobile-friendly download handlers for the Google Maps to GPX converter app.
This module provides additional routes and utilities to improve downloading on mobile devices.
"""

import os
import secrets
import tempfile
from flask import send_file, abort, request, render_template, jsonify, url_for
    ...
    def store_temp_file(file_content, original_name=None):
        ...
        try:
            ...
            app.config['TEMP_FILE_METADATA'][temp_id] = {
                ...
                'created': os.path.getmtime(temp_path)
            }
